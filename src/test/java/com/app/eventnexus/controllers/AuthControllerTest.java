 ...
 * mocked, and Spring Security +
 * {@link com.app.eventnexus.config.SecurityConfig}
...
class AuthControllerTest {
        ...
        void register_returnsConflict_whenEmailIsAlreadyRegistered() throws Exception {
                ...
                mockMvc.perform(post("/api/auth/register")
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("Email 'admin@test.com' is already registered."));
        }
        ...
        void refresh_returnsConflict_whenRefreshTokenIsExpired() throws Exception {
                ...
                mockMvc.perform(post("/api/auth/refresh")
                                ...
                                .andExpect(jsonPath("$.status").value(409))
                                .andExpect(jsonPath("$.message")
                                                .value("Refresh token has expired. Please log in again."));
        }
